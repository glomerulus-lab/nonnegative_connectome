...
for filepath in glob.glob('/home/stillwj3/Documents/research/lowrank_connectome/matlab/solution/lambda_test_*.mat'):
    ...
    # os.mkdir(path)
    command = "python nonnegative_converter.py test " + filename[0] + " lambda_tests/ lambda_tests/ " + "test_load_lamb" + " 400 14 50 400 14 50 -init_tol 1e-6 -tol 1e-7 --load_lamb -from_lc"
    os.system(command)
